...
public class DeleteMeetingSlipEntries extends ActionSupport implements ModelDriven<MeetingSlipEntryModal> {
	...
	public String execute(){
		...
		meetingSlipService.deleteMeetingSlipEntries(uidForEnrolled);
		return SUCCESS;
