...
<link rel="stylesheet" type="text/css" href="css/admin/viewSearch.css" />
...
<!--row 1-->
	<div class=" row administrationHeader ">
    	<h3 class="col-sm-offset-1">V|I|E|W S|E|A|R|C|H</h3>
    </div>
...
<!--row 3-->
<div class="row tableRowViewSearch">
            		...
            		<table class="table table-bordered tableShades">
                        ...
                        <tr>
							...
							<s:if test="%{enrolledStatus==null}">
                       		...
                       		<s:else>
                       			<td><a href="" class="enrolledView cssEnrolledOk"  >Enrolled</a><a class="enrolledDetail" href="enrolledDetailView?uidForEnrolled=<s:property value="%{#arr.uid}"/>" ><span class="glyphicon glyphicon-ok"></span></a></td>
                        		<td><a class="feedetails" href="fromAdminFeeSLip?uidForEnrolled=<s:property value="%{#arr.uid}"/>"><span id="gly" class="glyphicon glyphicon-usd"></span> </a></td>
                        	</s:else>
							...
							<td><a class="deleteRecord" href="fromAdminEnrolledDetailViewDelete?uidForEnrolled=<s:property value="%{#arr.uid}"/>"><span id="gly" class="glyphicon glyphicon-trash"></span> </a></td>
                        </tr>
...
<!--modal box end-->  
		<input type="button" id="printBtnViewSearch" class="col-sm-offset-6 btn btn-primary" value="Print" />
